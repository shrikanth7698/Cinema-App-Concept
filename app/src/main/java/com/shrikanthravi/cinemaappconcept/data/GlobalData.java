...
public class GlobalData {
    ...
    public static String[] movies = new String[]{"Black Panther","Blade Runner","Insidious - The Last Key"};
    public static String[] genres = new String[]{"Fantasy / Science fiction","Fantasy / Mystery","Mystery / Thriller"};
